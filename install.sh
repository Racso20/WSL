...
sleep 2
sudo apt install python3 python3-pip wordlists seclists exploitdb man nmap wafw00f whatweb sqlmap lsd bat squid openvpn testssl.sh xclip jq wpscan traceroute -y
